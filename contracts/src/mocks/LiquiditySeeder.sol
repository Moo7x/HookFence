...
/// @notice DEMO FIXTURE. Adds liquidity to a v4 pool.
/// @dev Used by the local deployment script to create a tradeable market against
///      mock assets. Not part of the product; there is no production reason for
///      Jayo to provide liquidity.
